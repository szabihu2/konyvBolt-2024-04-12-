    ...
    <div id="templatemo_container">
        <div id="templatemo_menu">
            <ul>
                ...
                <li><a href="LoggedInMain.php" class="current" id="top">Főoldal</a></li>
    ...
    <div ng-if="selectedBook" class="templatemo_content_right">
        <div>
            ...
            <div class="product_info">
                ...
                <br>
                <a href="vasarlasReszletek.php" class="reszletek">Vásárlás</a>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="lapozo_div">
                  <a href="#top" class="lapozo" ng-click="previousPage()">Előző</a> 
                <div class="lapozo_margin"></div>
                  <a href="#top" class="lapozo" ng-click="nextPage()"> Következő</a>
            </div>
        </div>
        <div id="templatemo_footer">
            <a href="LoggedInMain.php">Főoldal</a> | <a href="#kifejezes">Keresés</a>
            <br>
